...
const ENEMY_TYPES := [
	{"base_hp": 18, "hp_per_wave": 5,  "speed": 65,  "damage": 8,  "xp": 3,  "mat": 2, "color": Color(0.27, 1.0, 0.53)},   # slime
	{"base_hp": 10, "hp_per_wave": 2,  "speed": 115, "damage": 5,  "xp": 2,  "mat": 1, "color": Color(0.67, 0.53, 1.0)},  # bat
	{"base_hp": 45, "hp_per_wave": 9,  "speed": 38,  "damage": 14, "xp": 5,  "mat": 4, "color": Color(0.67, 0.67, 0.67)},  # rock
	{"base_hp": 110,"hp_per_wave": 22, "speed": 44,  "damage": 18, "xp": 14, "mat": 10, "color": Color(1.0, 0.27, 0.27)}, # elite (wave 5+)
]
...
func _on_spawn_timer_timeout() -> void:
	var count := 1 + int(GameManager.wave / 6)
...
func _spawn_enemy() -> void:
	...
	var hp := float(t["base_hp"] + t["hp_per_wave"] * GameManager.wave)
	enemy.setup(hp, float(t["speed"]) + GameManager.wave * 2.0,
		float(t["damage"]), t["xp"], t["mat"])
