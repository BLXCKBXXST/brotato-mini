...
func _clamp_to_arena() -> void:
	global_position.x = clampf(global_position.x, ARENA_MIN.x + HALF_E.x, ARENA_MAX.x - HALF_E.x)
	global_position.y = clampf(global_position.y, ARENA_MIN.y + HALF_E.y, ARENA_MAX.y - HALF_E.y)
